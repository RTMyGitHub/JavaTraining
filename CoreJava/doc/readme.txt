		In this project, this is the order you may want to practice the examples.

Topic	:	Hello world
package : 	com.training.java.core.helloworld
classes : 	HelloWorld.java
			HelloWorldWithArguments.java

Topic	: 	Basic OO concepts
